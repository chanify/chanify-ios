...
- (void)viewDidLoad {
    ...
    _url = [NSString stringWithFormat:@"chanify://offline/user?key=%@", [user.key.seckey.base64 stringByAddingPercentEncodingWithAllowedCharacters:NSCharacterSet.alphanumericCharacterSet]];
